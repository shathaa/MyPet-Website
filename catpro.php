	...
	if(isset($_SESSION["shopping_cart"]))  
      {  
           ...
           {  
                ...
                echo '<script>window.location="catpro.php"</script>';  
           }  
      }  
      else  
      {  
...
<img src= "image/tumblr_mfavz7AT331rgpyeqo1_250.gif" style="float:left ;"/> 
<label class="labl" id="Food">&nbsp &nbsp CAT FOOD</label>
...
$query = "SELECT * FROM product where (petType='cat'&& proType='food')";	
if ($r = mysqli_query ($db, $query)) {
 

while ($row = mysqli_fetch_array ($r)) {		 

print'<form action="catpro.php" method="post">
...
?>
 ...
 <div class="container2 container">
  <label class="labl"  id="Food Supplier">&nbsp &nbsp CAT FOOD SUPPLIER</label>
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='cat'&& proType=' Container')";	
if ($r = mysqli_query ($db, $query)) {
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='cat'&& proType=' supplier')";	
if ($r = mysqli_query ($db, $query)) {
...
<div class="container2 container" >
 <label class="labl"  id="Toys">&nbsp &nbsp CAT TOYS</label>
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='cat'&& proType='toy')";	
if ($r = mysqli_query ($db, $query)) {
...
<div class="container2 container">
 <label class="labl"  id="Health Care">&nbsp &nbsp CAT HEALTH CARE </label>
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='cat'&& proType='care')";	
if ($r = mysqli_query ($db, $query)) {
...
<div class="container-last container2  container">
 <label class="labl"  id="Cages">&nbsp &nbsp CAT BED AND CARRIER</label>
<?php
ini_set ('display_errors', 1);
error_reporting (E_ALL & ~E_NOTICE);
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='cat'&& proType='bed')";	
if ($r = mysqli_query ($db, $query)) {
