	...
	if(isset($_SESSION["shopping_cart"]))  
      {  
           ...
           {  
                ...
                echo '<script>window.location="birdpro.php"</script>';  
           }  
      }  
      else  
      {  
...
<br /><br />
<img src= "image/ezgif2.gif" style="float:left ;"/> 
<img src= "image/ezgif-1-b004fa1987.gif" style="float: right;"/> 

<label class="labl" id="Food">&nbsp &nbsp BIRD FOOD</label>
 <?php 
...
$query = "SELECT * FROM product where (petType= 'bird' && proType= 'food')";	
if ($r = mysqli_query ($db, $query)) {
 

while ($row = mysqli_fetch_array ($r)) {		 

print'<form action="birdpro.php" method="post">
...
<div class="container2 container" > 
 <label class="labl"  id="Food Supplier">&nbsp &nbsp BIRD FOOD SUPPLIER</label>
 <?php 
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='bird'&& proType='supplier')";	
if ($r = mysqli_query ($db, $query)) {
...
<div class="container2 container" >
 <label class="labl"  id="Toys">&nbsp &nbsp BIRD TOYS</label>
<?php 
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='bird'&& proType='toy')";	
if ($r = mysqli_query ($db, $query)) {
...
<div class="container2 container">
 <label class="labl"  id="Health Care">&nbsp &nbsp BIRD HEALTH CARE </label>
<?php 
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='bird'&& proType='care')";	
if ($r = mysqli_query ($db, $query)) {
...
<div class="container-last container2  container">
 <label class="labl"  id="Cages">&nbsp &nbsp BIRD CAGES </label>
<?php 
...
die ('<p>Could not connect to MySQL because: <b>' . mysqli_error($db) . '</b></p>');}
$query = "SELECT * FROM product where (petType='bird'&& proType='cage')";	
if ($r = mysqli_query ($db, $query)) {
